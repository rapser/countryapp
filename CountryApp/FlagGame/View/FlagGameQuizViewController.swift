...
final class FlagGameQuizViewController: UIViewController, FlagGameQuizViewProtocol {
    ...
    /// Índice actualmente resaltado (selección sin confirmar). Permite recolorear solo los
    /// botones que cambian en vez de los 4.
    ...
    override func viewDidLoad() {
        ...
        header.configure(title: "¿De qué país es?")
        ...
        NSLayoutConstraint.activate([
            ...
            flagCard.heightAnchor.constraint(equalToConstant: 220),
            ...
            optionsStack.topAnchor.constraint(equalTo: flagCard.bottomAnchor, constant: AppMetrics.spacing5),
    ...
    private func finishTapped() {
        ...
        alert.addAction(UIAlertAction(title: "Terminar", style: .destructive) { [weak self] _ in
            ...
            AppLog.trace("FlagGameQuizVC Terminar partida (menu) → pushSummary")
